       ...
       fflush(stdin); scanf("%c", &op);
        ...
        switch(op){
            ...
            case '2':case 'a':case'A':case'+':{
                ...
                CLEAR_SCREEN;
                puts("Digite o nome curto da disciplia, sem espaços.");
                puts("ex.: \"AED\" em vez de \"Alg. Estr. de Dados\"");
				puts("----------------------------------------------");
                printf("\nDegite o nome curto da disciplina:\n-> ");
                fflush(stdin);
                scanf("%s", input_title);	// tem que ser scanf("%s") para evitar espaços!!

                printf("\nDegite o nome do docente da disciplina:\n-> ");
...
void menu_sobre(){
    ...
    puts("                             Fábio Perreira");
    puts("                              Irany Moreno\n\n");
    puts("Agradecimento ao professor José Olavo Teixeira.\n\n\n");
    PAUSE_SCREEN;
    return;
}
